                    ...
                    <form method="POST" action="GestionCategorieServlet?action=update&idCategorie=${updateCategorie.idCategorie}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="libelleCategorie" value="${updateCategorie.libelleCategorie}" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="CategorieServlet" class="btn btn-danger" type="button"> <i class="fa fa-close"></i> Annuler</a>
