         ...
         <div class="right_col" role="main">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Liste des acteurs et réalisateurs <small></small></h2>
                  ...
                  <button class="btn btn-success" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus"></i> Ajouter</button>
                      ...
                      <c:choose>
                      	<c:when test="${! empty listParticipant}">
                      ...
                      <tbody>
                      		 <c:forEach items="${listParticipant}" var="participant">
                      			...
                      			<c:set var="count" value="${count + 1}" scope="page"/>
			                          ...
			                          <td><c:out value="${participant.idParticipant}"></c:out> </td>
				                      <td><c:out value="${participant.nomParticipant}"></c:out></td> 
				                      <td><c:out value="${participant.prenomParticipant}"></c:out> </td>
				                      
				                      <td><font color="red" ><a class="btn btn-success" href="ParticipantServlet?update=true&idParticipant=${participant.idParticipant}"><i class="fa fa-pencil"></i> Modif</a><a class="btn btn-danger" href="GestionParticipantServlet?supp=true&idParticipant=${participant.idParticipant}"> <i class="fa fa-trash"></i> Supp</a></font> </td>
                       		    </tr>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h3>Ajouter un acteur réalisateur </h3>
          
          
        </div>
        <div class="modal-body">
        
          <form method="POST" action="GestionParticipantServlet?action=insert" class="form-horizontal form-label-left"> 
          	        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nom<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nomParticipant"  id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="prenomParticipant"  id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
