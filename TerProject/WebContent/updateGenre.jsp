          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Modifier un genre de vidéo </h2>
                    ...
                    <form method="POST" action="GestionGenreServlet?action=update&idGenre=${updateGenre.idGenre}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="libelleGenre" value="${updateGenre.libelleGenre}" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
