            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <h2>Liste des administrateurs <small></small></h2>
                  ...
                  <br />
                      ...
                      <c:choose>
                      	<c:when test="${! empty listAdministrateur}">
                      		...
                      		<!-- Parcours la liste des administrateurs  -->
                      		 ...
                      		 <c:forEach items="${listAdministrateur}" var="admin">
                      			...
                      			<c:set var="count" value="${count + 1}" scope="page"/>
				                      ...
				                      <td><c:out value="${admin.prenomAdmin}"></c:out></td> 
				                      <td><c:out value="${admin.email}"></c:out></td> 
				                      
				                      <td><font color="red" ><a class="btn btn-success" href="AdministrateurServlet?update=true&idAdmin=${admin.idAdmin}"><i class="fa fa-pencil"></i> Modif</a><a class="btn btn-danger" href="GestionAdministrateurServlet?supp=true&idAdmin=${admin.idAdmin}"> <i class="fa fa-trash"></i> Supp</a></font> </td>
                       		    </tr>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="GestionAdministrateurServlet?action=insert" class="form-horizontal form-label-left"> 
          	        <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="password"  id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <br>
                      <div class="form-group">
